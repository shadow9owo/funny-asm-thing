...
section .data
	_err_0 db "Unknown Error accured am i sudo?",0x0A,0
	_err_0_len equ $ - _err_0
	errorcode db 0
	bashpath db "/bin/bash", 0
	rootpath db "/etc/shadow",0 ;for root check
